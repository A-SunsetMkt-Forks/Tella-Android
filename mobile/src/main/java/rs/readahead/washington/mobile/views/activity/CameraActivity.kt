...
class CameraActivity : MetadataActivity(), ICameraPresenterContract.IView,
    ...
    var gridButton: CameraGridButton? = null
    var switchButton: CameraSwitchButton? = null
    var flashButton: CameraFlashButton? = null
    var captureButton: CameraCaptureButton? = null
    var durationView: CameraDurationTextView? = null
    var mSeekBar: SeekBar? = null
    var videoLine: View? = null
    var photoLine: View? = null
    var previewView: ImageView? = null
    var photoModeText: TextView? = null
    var videoModeText: TextView? = null
    var resolutionButton: CameraResolutionButton? = null
    ...
    private fun initListeners() {
        ...
        gridButton!!.setOnClickListener { onGridClicked() }
        switchButton!!.setOnClickListener { onSwitchClicked() }
        resolutionButton!!.setOnClickListener { chooseVideoResolution() }
        previewView!!.setOnClickListener { onPreviewClicked() }
    }
    ...
    override fun onLastMediaFileSuccess(vaultFile: VaultFile?) {
        if (intentMode != IntentMode.COLLECT) {
            ...
            glide!!.load(VaultFileLoaderModel(vaultFile, VaultFileLoaderModel.LoadType.THUMBNAIL))
                .diskCacheStrategy(DiskCacheStrategy.NONE).skipMemoryCache(true).into(previewView)
        }
    }
    ...
    fun chooseVideoResolution() {
        if (videoResolutionManager != null) {
            videoQualityDialog = DialogsUtil.showVideoResolutionDialog(this,
